    ...
    <div className="animate-fadeIn">
      ...
      <div className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white tracking-tight">Department Overview</h1>
          <p className="text-lg text-slate-600 dark:text-slate-400 mt-4 max-w-3xl leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white">Academic Approach</h2>
              ...
              <div className="bg-indigo-50 dark:bg-indigo-900/20 p-6 rounded-xl border border-indigo-100 dark:border-indigo-900/40 mt-8">
                <h4 className="font-bold text-indigo-900 dark:text-indigo-300 mb-2">Centre of Excellence</h4>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-indigo-800 dark:text-indigo-400">
            ...
            <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <div className="space-y-8 relative">
                <div className="absolute left-[11px] top-2 bottom-2 w-[2px] bg-indigo-100 dark:bg-indigo-900"></div>
                {MILESTONES.map((m, idx) => (
                  <div key={idx} className="relative pl-10">
                    <div className="absolute left-0 top-1.5 w-[24px] h-[24px] bg-white dark:bg-slate-900 border-4 border-indigo-600 rounded-full z-10"></div>
                    <div>
                      <span className="text-xs font-bold text-indigo-600 dark:text-indigo-400 block mb-1 uppercase tracking-widest">{m.year}</span>
                      <h5 className="font-bold text-slate-900 dark:text-white">{m.title}</h5>
