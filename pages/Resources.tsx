      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              <h3 className="text-xl font-bold mb-6 flex items-center gap-3 text-slate-900 dark:text-white">
                <i className="fas fa-book-open text-indigo-600 dark:text-indigo-400"></i>
                Syllabus Overview
              </h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-6 flex items-center gap-3 text-slate-900 dark:text-white">
                <i className="fas fa-download text-indigo-600 dark:text-indigo-400"></i>
                Downloads
              </h3>
              <div className="space-y-4">
                {RESOURCES.map(resource => (
                  <div key={resource.id} className="bg-slate-50 dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center justify-between hover:border-indigo-400 transition-all group shadow-sm">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-lg flex items-center justify-center text-indigo-600 dark:text-indigo-400 border border-slate-100 dark:border-slate-700 shadow-sm">
                        <i className={`fas ${resource.type === 'PDF' ? 'fa-file-pdf' : 'fa-file-word'} text-xl`}></i>
                      </div>
                      <div>
                        <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors">{resource.title}</h4>
                    ...
                    <a 
                      href={resource.url} 
                      className="w-10 h-10 bg-white dark:bg-slate-800 hover:bg-indigo-600 hover:text-white rounded-full flex items-center justify-center transition-all text-slate-600 dark:text-slate-300 shadow-sm border border-slate-200 dark:border-slate-700"
                      title="Download"
                    >
          ...
          <div className="space-y-8">
            <div className="bg-indigo-600 dark:bg-indigo-900 rounded-3xl p-8 text-white shadow-xl">
              ...
              <button className="w-full bg-white text-indigo-600 py-3 rounded-xl font-bold text-sm hover:bg-slate-50 transition-colors shadow-md">
            ...
            <div className="bg-slate-50 dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              <ul className="space-y-3 text-sm font-bold text-slate-700 dark:text-slate-300">
                <li className="flex items-center gap-3"><i className="fas fa-laptop-house text-indigo-600 dark:text-indigo-400"></i> Open-Source Lab Access</li>
                <li className="flex items-center gap-3"><i className="fas fa-chalkboard-teacher text-indigo-600 dark:text-indigo-400"></i> Seminar Guidance</li>
                <li className="flex items-center gap-3"><i className="fas fa-envelope text-indigo-600 dark:text-indigo-400"></i> Official Gmail Help</li>
              </ul>
            </div>
          </div>
        </div>
