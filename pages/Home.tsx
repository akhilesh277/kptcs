      ...
      <section className="relative h-[500px] flex items-center overflow-hidden bg-slate-100 dark:bg-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            <span className="text-cyan-600 dark:text-cyan-400 font-bold tracking-[0.3em] uppercase text-[10px] mb-4 block">Official Web Portal</span>
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-6 leading-tight">
              Computer Science & Engineering<br />
              <span className="text-cyan-600 dark:text-cyan-400">KPT Mangalore</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                ...
                className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-600 to-teal-500 hover:from-cyan-700 hover:to-teal-600 text-white font-bold py-3 px-6 rounded-xl transition-all shadow-lg hover:shadow-cyan-500/25"
              >
      ...
      <section className="py-16 bg-slate-100 dark:bg-black text-slate-900 dark:text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-slate-700 dark:text-slate-400 list-none p-0">
                <li className="flex gap-4">
                  <span className="text-cyan-600 dark:text-cyan-400 font-bold">01.</span>
                  Evolve continually as a centre of excellence in quality education.
                </li>
                <li className="flex gap-4">
                  <span className="text-cyan-600 dark:text-cyan-400 font-bold">02.</span>
                ...
                <li className="flex gap-4">
                  <span className="text-cyan-600 dark:text-cyan-400 font-bold">04.</span>
          ...
          <div className="hidden md:flex items-center justify-center opacity-10 dark:opacity-20">
            <i className="fas fa-microchip text-[12rem] text-cyan-500"></i>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {ANNOUNCEMENTS.map(item => (
              <div key={item.id} className="p-6 border border-slate-200 dark:border-slate-800 rounded-xl hover:border-cyan-200 dark:hover:border-cyan-800 transition-colors shadow-sm bg-slate-50 dark:bg-slate-900">
                <span className="text-[10px] font-black uppercase tracking-widest text-cyan-600 dark:text-cyan-400 block mb-2">{item.date}</span>
