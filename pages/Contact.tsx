    ...
    <div className="animate-fadeIn py-16 dark:bg-slate-950">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-4 text-lg">Official communication channels for KPT Mangalore College.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Official Info */}
          <div className="bg-slate-900 dark:bg-black text-white rounded-3xl p-8 md:p-10 shadow-xl border border-slate-800">
          ...
          <div className="flex flex-col justify-center">
            <div className="p-8 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm h-full">
              <h3 className="text-xl font-bold mb-6 text-slate-900 dark:text-white border-b border-slate-100 dark:border-slate-800 pb-4">Visitor Guidelines</h3>
              ...
              <div className="mt-12 pt-8 border-t border-slate-100 dark:border-slate-800">
                ...
                <p className="text-sm font-bold text-slate-900 dark:text-white mt-1">KPT Mangalore College Office</p>
              </div>
            </div>
          </div>
        </div>
